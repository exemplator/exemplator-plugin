...
var sendRequest = function (exemplatorPluginView, packageName, className, methodName, plainStr, page = 0) {
    console.log("hi 1")
...
var handleResponse = function (exemplatorPluginView, responseText) {
    ...
    var emptyData = {
        examples: [
            {
                user: 'bill',
                score: responseArray[0].userUrl,
                code: responseArray[0].code
            }, {
                user: '',
                score: responseArray[1].userUrl,
                code: responseArray[1].code
            }
        ]
    };

    console.log(emptyData);
    exemplatorPluginView.setData(emptyData);
}
...
export default {
    ...
    showExamples() {
        ...
        sendRequest(this.exemplatorPluginView, "test", "test", "test", "test");
